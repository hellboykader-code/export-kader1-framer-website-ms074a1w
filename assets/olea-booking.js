...
(function(){
  ...
  function onSubmit(f){
    ...
    data.append('site','olea'); data.append('_subject','Nouvelle demande de rendez-vous — Cabinet Oléa');
  ...
  function findOld(){
    ...
    document.querySelectorAll('form').forEach(function(fm){
      ...
      if(fm.querySelector('select[name="Services"],input[name="Name"],input[name="Date"]')) old=fm;
    });
    return old;
  }
