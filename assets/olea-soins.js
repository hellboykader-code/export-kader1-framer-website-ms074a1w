...
(function(){
  ...
  function thumb(i,s){
    return '<span class="olea-thumb"><img src="'+BASE+'/assets/soins/'+IMG[i]+'.webp" alt="'+s.t+'" loading="lazy" decoding="async"></span>';
  }
  function buildGrid(){
    ...
    var cards=SOINS.map(function(s,i){
      return '<article class="olea-soin" data-cat="'+s.c+'">'+thumb(i,s)+
